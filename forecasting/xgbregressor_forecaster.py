    ...
    target variable to the training set.
        Inputs:
            ...
            - target_column (string): the column name of the target variable in the dataframe 
              to be forecast.
            - train_columns (list): a list of column names to be used as traning features.  If
              unspecified, the default value is None and a list of default training features is 
